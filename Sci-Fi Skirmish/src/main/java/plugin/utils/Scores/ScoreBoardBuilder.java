...
public class ScoreBoardBuilder {
    ...
    public static Scoreboard Scoreboard(PlayerStats stats, Player p){
        ...
        Score score9 = objective.getScore("§i   §8▸§d " + stats.getUwu() + " ♛");
        Score score10 = objective.getScore("§j  ");
        Score score13 = objective.getScore("§k §8· §7K/D:");
        Score score14 = objective.getScore("§p   §8▸§c " + kd + " ⚔");
        Score score15 = objective.getScore("§q");
        Score score11 = objective.getScore("§r    §8[§aNicht in Combat§8]");
        if(CombatLogger.isInCombat(p)){
            score11 = objective.getScore("§r       §8[§cIn Combat§8]");
        }
